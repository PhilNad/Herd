...
XBeeResponse::XBeeResponse() {
	...
	Phil 13/10/2014
	WARNING:
	If you put a call to Serial.println(); here, it will screw up the serial connection and will create DeviceManager's Code 43.
	See here for more details:http://forum.pjrc.com/threads/26492-Teensy-3-1-quot-USB-Device-Not-Recognized-quot-HELP!
	*/
}
        ...
        switch(_pos) {
			...
			default:
				...
				if (_pos == (_response.getPacketLength() + 3)) {
					...
					_checksumTotal = 0;
					return; //It seems after we have returned, the MCU hangs.
				} else {
